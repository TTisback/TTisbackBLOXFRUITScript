...
local trueData = "aa222a72093c4ff99d86b151b25f7aae"
local falseData = "865bfad9741a4350986ed041b9c465b6"

KeyGuardLibrary.Set({
  publicToken = "6ea652329f804c3eb22c3ecf849345a0",
  privateToken = "58d81961903e41e0ba76a2397c56527a",
  trueData = trueData,
  falseData = falseData,
})
...
local Window = Fluent:CreateWindow({
    Title = "TTisBack 2.0 | Blox Fruits",
    SubTitle = "Version 2",
    TabWidth = 160,
...
Tabs.Main:AddButton({
        ...
        Callback = function()
        setclipboard("https://discord.gg/2m3u3z8y")
        end
        })
...
Fluent:Notify({
    Title = "TTisBack 2.0",
    Content = "Thanks For Using TTisBack 2.0",
    Duration = 8
})
